...
def calculate_final_score(tf_results, bollinger_score, rsi_score, ema_score, market_regime, volume_score, whale_score, fvg_score, sd_score, stop_hunt_score, vwap_score, quality_score):
    alignment_score = 0
...
async def signal(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        final_score = calculate_final_score(
            tf_results, bb_score, rsi_score, ema_score,
            market_regime_score, volume_score, whale_score,
            fvg_score, sd_score, stop_hunt_score, vwap_score, quality_score
        )
        ...
        msg = (
            ...
            f"📈 **وضعیت پارامترها:**\n"
            f"هم‌جهتی     {bar(alignment_score)} {alignment_score}%  {dir_emoji[get_alignment_direction(tf_results)]}\n"
